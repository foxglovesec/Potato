...
namespace SharpCifs
{
    ...
    {        
        ...
        public static AutoResetEvent signalHandler = new AutoResetEvent(false);
        ...
        private static INtlmContextFactory _contextFactory;

        public class INtlmContextFactoryImpl : INtlmContextFactory
        {
        ...
        public class QueuedNtlmContextFactoryImpl : INtlmContextFactory
        {
            public INtlmContext create(NtlmPasswordAuthentication auth, bool doSigning)
            {
        ...
        public static INtlmContextFactory getNtlmContextFactory() {
            if(_contextFactory == null) {
                return new INtlmContextFactoryImpl();
            } else {
                return _contextFactory;
            }
        }

        public static void setNtlmContextFactory(INtlmContextFactory factory)
        {
